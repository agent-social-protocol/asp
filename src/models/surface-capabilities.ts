...
export const REFERENCE_SURFACE_CAPABILITIES: SurfaceCapabilities = {
  ...
  inbox: {
    ...
    notes: 'Core protocol inbox surface. The reference runtime can read it through CLI and MCP. Live receive prefers manifest-declared stream support and otherwise falls back to polling. The reference CLI exposes `inbox --follow` as the foreground live view and `watch` as a background local mirror/interim bridge.',
  },
  notifications: {
